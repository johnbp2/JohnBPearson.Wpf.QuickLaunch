...
namespace JohnBPearson.FileObjects
{
    ...
    public class FileSystemObjectFactory
    {
        ...
        public static FileModel.IFileSystemObjectBase Build(string path, FileInfo fileInfo)
        {
       ...
       //     var unknkownFileSystemObject = new System.IO.FileInfo(path);
            ...
            {
                case Constants.dir:
                    return new JohnBPearson.FileObjects.FileModel.Directory(path, unknkownFileSystemObject);
                    
                
                case Constants.lnk:
                    return new JohnBPearson.FileObjects.FileModel.BinaryLinkFormat(path, unknkownFileSystemObject);

                   
                case Constants.exe:
                    return new JohnBPearson.FileObjects.FileModel.BinaryLinkFormat(path, unknkownFileSystemObject);
                //case Constants.ini:
                //    return new JohnBPearson.FileObjects.FileModel.InitialIzation(path, unknkownFileSystemObject);
                case Constants.url:
                    return new JohnBPearson.FileObjects.FileModel.Url(path, unknkownFileSystemObject);
                default:
                    return null;
